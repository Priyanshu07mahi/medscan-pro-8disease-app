...
Original file is located at
    https://colab.research.google.com/drive/1U7aup-gfuD4rs7nRx-mbOlyl-M0z7IOC
"""
...
# ==================== DISEASE MODELS ====================
class DiseaseModel:
    def __init__(self, n_features):  # ✅ Fixed init
    ...
    try:
        with tempfile.NamedTemporaryFile(delete=False, suffix=".pdf") as tmp_file:
            ...
            for disease, status in predictions.items():
                color = (255,0,0) if status in ['Positive', 'High Risk', 'Detected', 'Abnormal'] else (0,155,0)
...
with gr.Blocks(theme=gr.themes.Soft(), title="MedScan Pro") as app:
    ...
    with gr.Row():
        with gr.Column():
            ...
            age = gr.Number(value=45, label="Age")  # ✅ safer
